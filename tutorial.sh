...
echo "   - Workflow ID: PWsz9WTxFMIpgSNf"
echo "   - Local File: workflows/workflow_PWsz9WTxFMIpgSNf.json"
...
echo "   cat workflows/workflow_PWsz9WTxFMIpgSNf.json | jq"
echo ""
echo "2. Edit workflow in VS Code:"
echo "   code workflows/workflow_PWsz9WTxFMIpgSNf.json"
echo ""
...
echo "🔄 How it works:"
echo "   1. Edit workflows/workflow_PWsz9WTxFMIpgSNf.json in VS Code"
